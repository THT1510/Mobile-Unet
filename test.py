...
def load_model(model_path, device):
    ...
    # Load model
    model = MobileNetUNet(img_ch=1, seg_ch=4, num_classes=3).to(device)
...
if __name__ == "__main__":
    ...
    model_path = r"D:\FPT BT\DBM\final project\train_model\checkpoint_new\best_model.pt"
    
    # Path to test image and ground truth mask
    image_path = r"D:\FPT BT\DBM\final project\train_model\Brain\test\image\no_tumor\Tr-no_0013.jpg"
    mask_path = r"D:\FPT BT\DBM\final project\train_model\Brain\test\mask\no_tumor\Tr-no_0013.png"
