...
class MobileNetUNet(nn.Module):
    def __init__(self, img_ch=1, seg_ch=2, num_classes=None):
        super().__init__()
        ...
        # PyTorch will use default initialization
...
if __name__ == "__main__":
    mobile_net_unet = MobileNetUNet(img_ch=1, seg_ch=2, num_classes=3)  # Changed seg_ch from 4 to 2
